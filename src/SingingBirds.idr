...
parameters {auto b : Type} {auto _ : Bird b} (xP : b) (Sings : b -> Type) 
    public export
    0 Law1 : Type 
    ...
    public export
    0 question1 : Decidable 1 [b] Sings => Law1 -> Law2 -> Law3 -> Law4 -> (x : b) -> Sings x
    ...
    %ambiguity_depth 8
    0 question2 : Decidable 1 [b] Sings =>  Law1 -> Law2 -> Law3 -> {xL : b} -> Lark xL -> {xC : b} -> Cardinal xC -> (x : b) -> Sings x
    ...
    0 question3 : Decidable 1 [b] Sings =>  Law1 -> Law2 -> Law3 -> {a : b} -> ((x : b) -> (y : b) -> (z :b) -> a <*> x <*> y <*> z = x <*> (z <*> z) <*> y) -> (x : b) -> Sings x
